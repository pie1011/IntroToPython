...
movies = ['Star Wars', 'Lion King', 'Endgame', 'Top Gun: Maverick']
...
string_to_change = "panic at the disco"
...
def zzz():
    student = students_in_order[3]['name']
    print(student)
...
def esteban_age():
    student = students_in_order[1]["age"]
    print(student)
