...
item_types = {
    "movies" : ["Inception", "Good Will Hunting"],
    "fruits" : ["blueberries"],
    "cars" : ["Toyota"]
}
...
for item in movie_list:
    if item in item_types["fruits"]:
        print("item is a fruit and not movie")
    elif item in item_types["cars"]:
        print("item is a car and not movie")
    else:
        print(movie)
